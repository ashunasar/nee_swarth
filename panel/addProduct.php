                     ...
                     <div class="row">
                        <div class="col-md-6">
                         <div class="form-group">
                           ...
                           <div class="form-group">
                              <input type="text" name="stock" class="form-control" placeholder="Available Stock" required>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              <input type="text" name="origin" class="form-control" placeholder="Country Of Origin" required>
                           </div>
                           <div class="form-group">
...
<?php
   if(isset($_POST['submit'])){
       ...
       $adminControl->addProductByCategory($name,$image_path,$price,$discounted_price,$stock,$description,$origin,$category);
